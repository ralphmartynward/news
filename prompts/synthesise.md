...
10. Listicle detection (listicle_items): if this article is a ranked or curated list ("top 10 lacs", "10 sorties incontournables", "7 choses à faire", "sélection de X adresses", "les meilleurs X", etc.), extract up to 10 items as listicle_items: [{title: "≤5 words", "description": "≤12 words, one concrete detail"}]. For all other articles set listicle_items to null.
...

{
  ...
  "listicle_items": [{"title": "Lac de Plaisance", "description": "baignade gratuite, 10 min de Toulouse"}] or null
}
